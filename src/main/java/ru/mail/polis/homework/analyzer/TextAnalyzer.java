...
public interface TextAnalyzer {
    ...
    boolean successfullyAnalyzed(String text);
     ...
     */
    static TextAnalyzer createCustomAnalyzer(String repeatingWord, int frequency) {
        return new FrequentWordRepetitionAnalyzer(repeatingWord, frequency);
    }
}
