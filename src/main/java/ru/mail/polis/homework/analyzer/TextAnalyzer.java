...
public interface TextAnalyzer {
    ...
    static TextAnalyzer createTooLongAnalyzer(long maxLength) {
        return new LengthAnalyzer(maxLength);
    }
    ...
    static TextAnalyzer createNegativeTextAnalyzer() {
        return new NegativeAnalyzer();
    }

    /**
     * придумать свой фильтр
     */
    static TextAnalyzer createCustomAnalyzer(String[] symbols, int[] maxSymbolCount) {
        return new CustomAnalyzer(symbols, maxSymbolCount);
    }

    FilterType analysis(String text);
