...
public interface TextAnalyzer {
    ...
    static TextAnalyzer createSpamAnalyzer(String[] spam) {
        return new SpamAndNegativeTextAnalyzer(spam, FilterType.SPAM);
    }

    static TextAnalyzer createNegativeTextAnalyzer() {
        return new SpamAndNegativeTextAnalyzer(new String[]{"=(", ":(", ":|"}, FilterType.NEGATIVE_TEXT);
    }

    /**
     * придумать свой фильтр (добавил фильм, что пробел не может быть длиннее 1 " " - OK, "   " - НЕОК)
     */
    static TextAnalyzer createSpaceLengthAnalyzer() {
        return new SpaceLengthAnalyzer();
    }
