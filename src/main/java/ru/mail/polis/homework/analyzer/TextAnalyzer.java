 ...
 * <p>
 * 2 балла + (2 балла за каждый фильтр + 1 балл за тест на свой фильтр) ОГО 11
 */
public interface TextAnalyzer {
     ...
     * Check have consecutive letters at least minCount times.
     */

    static TextAnalyzer createConsecutiveLettersAnalyzer(char letter, int minCount) {
        return new ConsecutiveLettersAnalyzer(letter, minCount);
    }
