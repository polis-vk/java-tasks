...
public interface TextAnalyzer {
     ...
     */
    //Проверяет, что предложение начинается с большой буквы и оканчивается на '.' || '!' || '?'
    static TextAnalyzer createCorrectStructureAnalyzer() {
        return new CorrectStructureAnalyzer();
    }

    boolean isAnalyze(String str);
