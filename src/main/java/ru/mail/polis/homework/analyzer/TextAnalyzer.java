...
public interface TextAnalyzer {
    ...
    static TextAnalyzer createTooLongAnalyzer(long maxLength) {
        return new TextLengthAnalyzer(maxLength);
    }

    static TextAnalyzer createSpamAnalyzer(String[] spam) {
        return new TextSpamAnalyzer(spam);
    }

    static TextAnalyzer createNegativeTextAnalyzer() {
        return new TextSmileyFacesAnalyzer();
    }
    ...
    static TextAnalyzer createCustomAnalyzer() {
        return new TextUpperCaseAnalyzer();
    }

    boolean analyzeText(String text);

    FilterType getTypeOfFilter();
}
