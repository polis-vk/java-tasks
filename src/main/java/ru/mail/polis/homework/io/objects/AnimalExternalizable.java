...
public class AnimalExternalizable implements Externalizable {
    ...
    public AnimalExternalizable(boolean isPet, boolean isWild, Integer legsCount, String name, Double age,
    ...
    public static class LivingEnvironment implements Externalizable {
        private double temperature;
        private Weather weather;

        public LivingEnvironment() {
