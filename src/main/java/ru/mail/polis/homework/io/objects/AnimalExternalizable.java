...
public class AnimalExternalizable implements Externalizable {
    ...
    private AnimalOwnerExternalizable owner;
    ...
    public AnimalExternalizable(int legs, boolean hair, boolean vertebrate, String name, AnimalType type,
                                AnimalOwnerExternalizable owner) {
        this.legs = legs;
        this.hair = hair;
    ...
    public AnimalOwnerExternalizable getOwner() {
        return owner;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof AnimalExternalizable)) {
            return false;
        }
    ...
    public void readExternal(ObjectInput in) throws IOException, ClassNotFoundException {
        ...
        owner = (AnimalOwnerExternalizable) in.readObject();
    }
}
