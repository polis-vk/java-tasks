...
public class PopularMap<K, V> implements Map<K, V> {
    ...
    public boolean containsKey(Object key) {
        popularityIncreasing((K) key, keyPopularity);
        return map.containsKey(key);
    }

    @Override
    public boolean containsValue(Object value) {
        popularityIncreasing((V) value, valuePopularity);
    ...
    public V get(Object key) {
        popularityIncreasing((K) key, keyPopularity);
        popularityIncreasing(map.get(key), valuePopularity);
        return map.get(key);
    }
    ...
    public V remove(Object key) {
        popularityIncreasing((K) key, keyPopularity);
        //TODO подумать над этой функцией, может есть способ сделать это без доп памяти...
    ...
    private <T> void popularityIncreasing(T param, Map<T, Integer> map) {
        map.compute(param, (k, integer) -> {
            if (integer == null) {
                integer = 0;
            }
            return integer++;
