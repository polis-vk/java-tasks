...
public class MailService<T extends Mail<?>> implements Consumer<T> {
    ...
    private final PopularMap<String, String> mailSubjects = new PopularMap<>();
    ...
    public void accept(T mail) {
        ...
        mailSubjects.put(sender, mail.getRecipient());
    ...
    public String getPopularSender() {
        return mailSubjects.getPopularKey();
    }
    ...
    public String getPopularRecipient() {
        return mailSubjects.getPopularValue();
    }
