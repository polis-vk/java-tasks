...
public class MailService<T extends Mail<?>> implements Consumer<T> {
    private final PopularMap<String, String> clientWithPopularity = new PopularMap<>();
    ...
    public void accept(T mail) {
        ...
        clientWithPopularity.put(sender, mail.getRecipient());
    ...
    public String getPopularSender() {
        return clientWithPopularity.getPopularKey();
    }
    ...
    public String getPopularRecipient() {
        return clientWithPopularity.getPopularValue();
    }
