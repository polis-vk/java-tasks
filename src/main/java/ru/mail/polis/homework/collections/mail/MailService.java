...
public class MailService implements Consumer<Mail<?>> {
    ...
    private final PopularMap<String, List<Mail<?>>> recipientsMap;
    private final PopularMap<String, List<Mail<?>>> sendersMap;

    public  MailService() {
        this.recipientsMap = new PopularMap<>();
        this.sendersMap = new PopularMap<>();
    }
    ...
    public void accept(Mail mail) {
        sendersMap.computeIfAbsent(mail.getSender(), e -> new ArrayList<>()).add(mail);
