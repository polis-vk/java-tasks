...
public class HomeworkTask {
    ...
    public static double calcIntegral(double a, double b, ToDoubleFunction<Double> function, double delta) {
        ...
        for (double step = a; step < b; step += delta) {
            integral += function.applyAsDouble(step) * delta;
        }
    ...
    public static double square(int x1, int y1, int x2, int y2, int x3, int y3, int x4, int y4) {
        ...
        double a = Math.sqrt(Math.pow((x1 - x2), 2) + Math.pow((y1 - y2), 2)); // длина первой стороны четырехугольника
        double b = Math.sqrt(Math.pow((x2 - x3), 2) + Math.pow((y2 - y3), 2)); // длина второй стороны четырехугольника
        double c = Math.sqrt(Math.pow((x3 - x4), 2) + Math.pow((y3 - y4), 2)); // длина третьей стороны четырехугольника
        double d = Math.sqrt(Math.pow((x4 - x1), 2) + Math.pow((y4 - y1), 2)); // длина четвертой стороны четырехугольника
        double diagonal = Math.sqrt(Math.pow((x3 - x1), 2) + Math.pow((y3 - y1), 2)); // длина диагонали четырехугольника
