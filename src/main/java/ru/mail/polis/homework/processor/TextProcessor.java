...
public interface TextProcessor {
    ...
    static TextProcessor squashWhiteSpacesProcessor() {
        return new SquashWhiteSpacesProcessor(ProcessingStage.PREPROCESSING);
    }
    ...
    static TextProcessor replaceFirstProcessor(String regex, String replacement) {
        return new ReplaceFirstProcessor(ProcessingStage.PROCESSING, regex, replacement);
    }
    ...
    static TextProcessor trimProcessor(int maxLength) {
        return new TrimProcessor(ProcessingStage.POSTPROCESSING, maxLength);
    }
    ...
    static TextProcessor upperCaseProcessor() {
        return new UpperCaseProcessor(ProcessingStage.POSTPROCESSING);
    }
