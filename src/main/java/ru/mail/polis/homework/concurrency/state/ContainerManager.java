...
public class ContainerManager {
    ...
    /**
     * спользуйте executor c расширяемым количеством потоков,
    ...
    /**
     * спользуйте executor c 2 потоками (общий с операцией finish),
    ...
    /**
     * спользуйте executor c 2 потоками (общий с операцией run), который будет принимать
    ...
    /**
     * спользуйте executor c 1 потоком, который будет принимать элемент из контейнеров
