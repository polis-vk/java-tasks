...
public class MailServiceTest {
    ...
    public void manyServices() {
        ...
        Map<String, SimpleMessage> recipients1 = mailService1.getMailBox();
        Map<String, SimpleMessage> recipients2 = mailService1.getMailBox();
