...
//        }
    ...
    private void createFile(Path path) throws IOException {
        List<String> strings = Arrays.asList("∆или-были три китайца: як, як-цедрак, як-цедрак-цедрак-цедрони.",
                ...
                "» у них родились дети. ” яка с ÷ыпой Ч Ўах, у яка-цедрака с ÷ыпой-дрыпой Ч Ўах-",
                "шарах, у яка-цедрака-цедрака-цедрони с ÷ыпой-дрыпой-дрымпампони Ч Ўах-шарах-шарах-широни.");
